...
- Analyzed correlations between metrics  
...
- **Corporate** and **Home Office** customers are more profitable  
- **Central** region leads in sales, while **Caribbean** and **Canada** are lower  
- **Discount** has a strong **negative correlation** with **Profit Margin (-0.85)**  
...
*This project is part of my journey toward becoming a Data Engineer with strong analytical foundations.*
